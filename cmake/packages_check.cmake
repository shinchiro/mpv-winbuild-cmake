if(COMPILER_TOOLCHAIN STREQUAL "gcc")
    ...
    set(mpv_debug COMMAND ${CMAKE_COMMAND} -E copy <BINARY_DIR>/mpv.debug ${CMAKE_CURRENT_BINARY_DIR}/mpv-debug/mpv.debug)
elseif(COMPILER_TOOLCHAIN STREQUAL "clang")
    ...
    set(mpv_debug COMMAND ${CMAKE_COMMAND} -E copy <BINARY_DIR>/mpv.pdb ${CMAKE_CURRENT_BINARY_DIR}/mpv-debug/mpv.pdb)
endif()
