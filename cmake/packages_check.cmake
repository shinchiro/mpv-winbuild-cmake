if(TARGET_CPU STREQUAL "x86_64")
    ...
    set(bit "64")
    set(vs_extract_lib "extract-lib")
elseif(TARGET_CPU STREQUAL "i686")
    set(dlltool_image "i386")
    set(bit "32")
    set(vs_extract_lib "install")
...
elseif(COMPILER_TOOLCHAIN STREQUAL "clang")
    ...
    set(vapoursynth_manual_install_copy_lib COMMAND ${CMAKE_COMMAND} -E copy <SOURCE_DIR>/sdk/lib${bit}/VSScript.lib ${MINGW_INSTALL_PREFIX}/lib/VSScript.lib
                                            COMMAND ${CMAKE_COMMAND} -E copy <SOURCE_DIR>/sdk/lib${bit}/VapourSynth.lib ${MINGW_INSTALL_PREFIX}/lib/VapourSynth.lib)
