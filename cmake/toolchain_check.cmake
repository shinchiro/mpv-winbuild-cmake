if(COMPILER_TOOLCHAIN STREQUAL "clang")
    ...
    check_cxx_compiler_flag("-Wa,-msse2avx -mno-vzeroupper" SSE2AVX_AVAILABLE)
    check_cxx_compiler_flag("-Wa,--crel,--allow-experimental-crel" CREL_AVAILABLE)
    check_cxx_compiler_flag("-static-pie" STATIC_PIE_AVAILABLE)
    ...
    if(STATIC_PIE_AVAILABLE)
        set(static_pie "-static-pie")
    endif()
endif()
