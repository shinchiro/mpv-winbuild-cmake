ExternalProject_Add(mimalloc-host
    ...
    CONFIGURE_COMMAND ${EXEC} CONF=1 PATH=$O_PATH PKG_CONFIG_LIBDIR= ${CMAKE_COMMAND} -H<SOURCE_DIR> -B<BINARY_DIR>
        ...
        "-DCMAKE_C_FLAGS='-DMI_DEBUG=0 ${llvm_cflags} ${llvm_lto} ${llvm_pgo}'"
        "-DCMAKE_CXX_FLAGS='-DMI_DEBUG=0 ${llvm_cflags} ${llvm_lto} ${llvm_pgo}'"
        "-DCMAKE_ASM_FLAGS='-DMI_DEBUG=0 ${llvm_cflags} ${llvm_lto} ${llvm_pgo}'"
