ExternalProject_Add(mimalloc-host
    ...
    BUILD_COMMAND ${EXEC} ninja -C <BINARY_DIR> & ${EXEC} ninja -C <BINARY_DIR>/shared
    INSTALL_COMMAND ${EXEC} ${CMAKE_COMMAND} --install <BINARY_DIR> & ${EXEC} ${CMAKE_COMMAND} -E copy <BINARY_DIR>/shared/libmimalloc.so ${CMAKE_INSTALL_PREFIX}/bin/libmimalloc.so
