ExternalProject_Add(xvidcore
    ...
    CONFIGURE_COMMAND ${EXEC} CONF=1 cd <SOURCE_DIR>/build/generic && ./configure # running configure outside that directory will make it happily ignore --host while building
        --host=${TARGET_ARCH}
